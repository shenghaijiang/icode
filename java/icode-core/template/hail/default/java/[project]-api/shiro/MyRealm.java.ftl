package ${model.packageName}.shiro;

import ${model.packageName}.interceptor.LoginToken;
import cn.xtits.xtf.common.utils.JsonUtil;
import cn.xtits.xtf.common.utils.JwtUtil;
import cn.xtits.xtf.common.web.AjaxResult;
import ${model.packageName}.sapi.xtp.ShiroDto;
import ${model.packageName}.sapi.xtp.ShiroService;
